...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen min-w-full mx-auto overflow-x-hidden">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-600 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <button
              className="btn btn-block btn-sm mt-2 border border-slate-700 bg-black text-white"
              disabled={loading}
            >
              {loading ? (
